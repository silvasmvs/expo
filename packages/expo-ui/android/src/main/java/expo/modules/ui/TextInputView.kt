...
import expo.modules.ui.textfield.MaskedVisualTransformation
      ...
      AutoSizingComposable(shadowNodeProxy, axis = EnumSet.of(Direction.VERTICAL)) {
        TextField(
          modifier = Modifier
            ...
            .onFocusChanged { if (it.isFocused) onTextFieldFocus(mapOf("value" to value)) else onTextFieldBlur(mapOf("value" to value)) },
          value = value,
          onValueChange = {
            value = it
